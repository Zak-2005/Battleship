...
test.only("Place ships at specific coordinates", () => {
  ...
  expect(gameboard.board[0][0] instanceof Ship).toBeTruthy();
  expect(gameboard.board[1][0] instanceof Ship).toBeTruthy();
  expect(gameboard.board[2][0] instanceof Ship).toBeTruthy();
  expect(gameboard.board[3][0] instanceof Ship).toBeTruthy();
});
